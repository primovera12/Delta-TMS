...
export default function DispatcherPatientDetailPage() {
            ...
            <CardContent>
              {patient.medicalProfile ? (
                <div className="grid gap-6 md:grid-cols-2">
                  <div>
                    <h4 className="text-sm font-medium text-gray-500 mb-2">Transport Type</h4>
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-gray-500 mb-2">Oxygen Required</h4>
                    <Badge variant={patient.medicalProfile.requiresOxygen ? 'warning' : 'secondary'}>
                      {patient.medicalProfile.requiresOxygen ? 'Yes' : 'No'}
                    </Badge>
                  </div>
                  <div>
                    <h4 className="text-sm font-medium text-gray-500 mb-2">Attendant Required</h4>
